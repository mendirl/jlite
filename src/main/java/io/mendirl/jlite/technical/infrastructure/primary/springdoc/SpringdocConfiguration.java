package io.mendirl.jlite.technical.infrastructure.primary.springdoc;
...
class SpringdocConfiguration {
  ...
  @Bean
  public OpenAPI jliteApplicationOpenAPI() {
  ...
  @Bean
  public GroupedOpenApi jliteApplicationAllOpenAPI() {
